...
export const translations = {
  id: {
    ...
    quote: '"Code is poetry, build it with heart."',

    // Nav
    home: 'Home', about: 'About', skills: 'Skills',
    projects: 'Projects', experience: 'Experience',
    education: 'Education', certificates: 'Certificates',
    testimonials: 'Testimonials', funfacts: 'Fun Facts',
    blog: 'Blog', contact: 'Contact',

    // About
    aboutLabel: 'About Me',
    aboutTitle: 'Passion di bidang',
    aboutTitleAccent: 'Web Development',
    ...
    nama: 'Nama', lokasi: 'Lokasi', email: 'Email',
    sekolah: 'Sekolah', jurusan: 'Jurusan', status: 'Status',
    statusVal: 'Fresh Graduate · Tersedia PKL',
    ...
    projectsTitleAccent: 'Built',

    // Experience
    expLabel: 'Experience',
    expTitle: 'My',
    expTitleAccent: 'Journey',
    work: 'Work', org: 'Organization',

    // Contact
    contactLabel: 'Contact',
    contactTitle: 'Mari',
    contactTitleAccent: 'Terhubung!',
    contactDesc: 'Terbuka untuk kolaborasi, diskusi project, atau sekadar ngobrol soal tech!',
    sendMsg: 'Kirim Pesan',
    yourName: 'Nama kamu',
    yourEmail: 'email@kamu.com',
    subject: 'Tentang apa?',
    message: 'Hei Abiyya...',
    sending: 'Mengirim...',
    sent: 'Pesan Terkirim!',
    sentDesc: 'Terima kasih sudah menghubungi Abiyya',
  },
  ...
  en: {
    ...
    nama: 'Name', lokasi: 'Location', email: 'Email',
    sekolah: 'School', jurusan: 'Major', status: 'Status',
    statusVal: 'Fresh Graduate · Available for Internship',
    ...
    yourName: 'Your name',
    yourEmail: 'email@you.com',
    subject: 'What is it about?',
    message: 'Hey Abiyya...',
    sending: 'Sending...',
    sent: 'Message Sent!',
    sentDesc: 'Thank you for reaching out to Abiyya',
  },
  ...
  zh: {
    ...
    subject: 'What is it about?', message: 'Hey Abiyya...',
    sending: 'Sending...', sent: 'Message Sent!', sentDesc: 'Thank you for reaching out',
  }
}
