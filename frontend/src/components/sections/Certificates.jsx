            ...
            {certificates.map(cert => (
              ...
              >
                <div style={{
                  ...
                  right: 0,
                  height: '3px',
                  background: `linear-gradient(90deg, ${t?.accent}, ${t?.navy})`
                }} />
                ...
                <div style={{ fontSize: '14px', fontWeight: '600', color: t?.text, marginBottom: '6px', lineHeight: 1.4 }}>
                  {cert?.name}
                </div>

                <div style={{ fontSize: '12px', color: t?.accent, marginBottom: '4px', fontWeight: '500' }}>
                  {cert?.issuer}
                </div>

                <div style={{ fontSize: '11px', color: t?.textFaint, marginBottom: '16px' }}>
                  {cert?.date}
                </div>
                ...
                {cert?.credential_url && (
                  ...
                  >
                    {tr?.cert_view_link || 'View Credential'}
                  </a>
                )}
              </div>
            ))}
